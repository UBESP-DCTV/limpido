...
architecture <- glue::glue("
    ...
    conv(1+2+3+4)x 64 + max_pool2 + batch_norm + dropout0.1 +
    conv(1+2+3+4)x128 + max_pool2 + batch_norm + dropout0.1 +
    conv(1+2+3+4)x256 + max_pool3 + batch_norm + dropout0.1 +
    fc6_softmax
")
...
l1 <- layer_concatenate(
    ...
    layer_dropout(rate = 0.1, name = "l1_dropout")
...
l2 <- layer_concatenate(
    ...
    layer_dropout(rate = 0.1, name = "l2_dropout")
...
l3 <- layer_concatenate(
    ...
    layer_dropout(rate = 0.1, name = "l3_dropout")
