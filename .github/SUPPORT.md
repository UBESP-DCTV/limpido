# Getting help with limpido

Thanks for using limpido. Before filing an issue, there are a few places
...
Before opening a new issue, be sure to [search issues and pull requests](https://github.com/tidyverse/limpido/issues) to make sure the 
